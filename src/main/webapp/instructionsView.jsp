    ...
    <div class="instructions-view">
        ...
        <div>
            <p>
                ...
                a party with friends, or a family evening, you will enjoy the simple yet surprisingly difficult gameplay.
            </p>
            <p>
                You play in teams, and take turns explaining the word on the screen without using the exact word. It is
                your teammates' job to guess witch word that you are describing. If they guess correctly, you press
                "correct". If you feel stuck, you can press "skip" and you get a new word. Try not to skip too many words, since it is
            ...
            <p>
                ...
                "correct" or "skip" depending on the outcome, then the turn moves on to the next team.
            </p>
            <p>
                ...
                player can sneakpeak at the screen (seeing the word without getting it from the explanation ruins the fun).
            </p>
            <p> You can enter how long each round should be, and how many rounds should be played, on the Settings page
                from the Main menu. After all rounds are played, the score is displayed and the team with the most points win
